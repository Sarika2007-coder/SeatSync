...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const addScheduleForm =
        document.getElementById("addScheduleForm");

    if (addScheduleForm) {
        addScheduleForm.addEventListener(
            "submit",
            handleAddSchedule
        );
    }
...
// ========================================
// LOAD ROUTES FOR SCHEDULE
// ========================================

async function loadScheduleRoutes() {
...
// ========================================
// LOAD BUSES FOR SCHEDULE
// ========================================

async function loadScheduleBuses() {
...
async function handleAddSchedule(event) {
    ...
    if (
        ...
        alert(
            "Please select route, bus, date and departure time."
        );
    ...
    try {
        ...
        logActivity("Added Schedule", "Added schedule for route " + routeId + " on " + travelDate);
        ...
        if (
            ...
            list.innerHTML = `
                <div class="empty-state">
                    ...
                    <p>
                        Add a schedule using the form above.
                    </p>
        ...
        .forEach(button => {
            ...
            button.addEventListener(
                ...
                async () => {
                    ...
                    logActivity("Updated Schedule", "Updated schedule ID: " + id);
        ...
        .forEach(button => {
            ...
            button.addEventListener(
                ...
                async () => {
                    ...
                    logActivity("Toggled Schedule", "Toggled schedule ID: " + id);
        ...
        .forEach(button => {
            ...
            button.addEventListener(
                ...
                async () => {
                    ...
                    logActivity("Deleted Schedule", "Deleted schedule ID: " + id);
